...
type P2P_MessageStreamClient interface {
	Send(*FreedMessage) error
	Recv() (*FreedMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *FreedMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*FreedMessage, error) {
	m := new(FreedMessage)
...
func (x *p2PMessageStreamServer) Send(m *FreedMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*FreedMessage, error) {
	m := new(FreedMessage)
...
func (x *rPCMessageStreamClient) Send(m *FreedMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*FreedMessage, error) {
	m := new(FreedMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *FreedMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*FreedMessage, error) {
	m := new(FreedMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
