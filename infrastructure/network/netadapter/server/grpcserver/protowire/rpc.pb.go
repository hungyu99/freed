...
type GetBlockTemplateResponseMessage struct {
	...
	// Whether freed thinks that it's synced.
	// Callers are discouraged (but not forbidden) from solving blocks when freed is not synced.
	// That is because when freed isn't in sync with the rest of the network there's a high
...
type GetConnectedPeerInfoMessage struct {
	...
	// Whether this freed initiated the connection
	...
	// The timestamp of when this peer connected to this freed
