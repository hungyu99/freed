...
// installService attempts to install the freed service. Typically this should
...
// removeService attempts to uninstall the freed service. Typically this should
...
// startService attempts to Start the freed service.
