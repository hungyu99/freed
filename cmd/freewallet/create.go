...
import (
	...
	"github.com/hungyu99/freed/cmd/freewallet/libkaspawallet/bip32"
	"github.com/hungyu99/freed/cmd/freewallet/utils"
	"github.com/pkg/errors"

	"github.com/hungyu99/freed/cmd/freewallet/keys"
)
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"freewallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"freewallet new-address\" to create and see one)\n\n")
