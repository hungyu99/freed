...
type createConfig struct {
	KeysFile          string `long:"keys-file" short:"f" description:"Keys file location (default: ~/.freewallet/keys.json (*nix), %USERPROFILE%\\AppData\\Local\\freewallet\\key.json (Windows))"`
